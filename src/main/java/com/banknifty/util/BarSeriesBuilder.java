...
public class BarSeriesBuilder {
	...
	/**
	 * Creates a TA4J BarSeries from immutable Candle records.
	 */
	public BarSeries build(List<Candle> candles) {

		BarSeries series = new BaseBarSeriesBuilder().withName("BANKNIFTY").build();
	...
	/**
	 * Converts application interval into TA4J duration.
	 */
